<template>
  <div>
    <b-modal v-model="modalShow" no-stacking centered hide-footer header-bg-variant="red">
       <template v-slot:modal-header="{ close }" >
      <h2  class="text-white">
        <v-icon  style="color:white" class="pr-2">mdi-library-books</v-icon>ทำการสร้างบทเรียนใหม่
      </h2>
       </template>
      <b-form @submit="onSubmit" @reset="onReset" ref="myform">
        <h5 class>
          กำหนดชื่อบทเรียนใหม่
        ...
        <h5 class="pt-3">กำหนดคำอธิบายบทเรียนใหม่</h5>
